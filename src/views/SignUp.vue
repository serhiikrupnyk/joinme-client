<template>
  <div>
    ...
    <v-card class="mx-auto pa-12 pb-8" elevation="8" max-width="448" rounded="lg">
      ...
      <v-text-field density="compact" placeholder="First Name" prepend-inner-icon="mdi-account" variant="outlined"
        v-model="firstName"></v-text-field>

      <div class="text-subtitle-1 text-medium-emphasis">Last Name</div>

      <v-text-field density="compact" placeholder="Last Name" prepend-inner-icon="mdi-account" variant="outlined"
      ...
      <v-card-text class="text-center">
        <router-link class="text-blue text-decoration-none" rel="noopener noreferrer" to="/signin">
